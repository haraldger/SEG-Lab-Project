...
if(!isset($_GET['oid'])) {
	redirect_to(url_for('officer/tournaments/tournamentOrganisers.php?id=' . $_GET['tid']));
}
...
if(!in_array(get_session_id(), $organiserIDs) || get_session_id() == $oid){
	redirect_to(url_for('officer/tournaments/tournamentOrganisers.php?id=' . $tid));
}
...
<!doctype html>
	...
	<div id="content" class="container mt-5 mb-5">
	  ...
	  <a class="back-link" href="<?php echo url_for('officer/tournaments/tournamentOrganisers.php?id=' . $tid); ?>">&laquo; Back to List</a>
		<br><br>
	  <div class="tournament organiser delete">
		...
		<form action="<?php echo url_for('/officer/tournaments/tournamentOrganiserDelete.php?oid=' .h(u($oid)). '&tid=' .h(u($tid))); ?>" method="post">
		  <div id="operations">
