...
if(!isset($_GET['id'])) {redirect_to(url_for('/member/profiles/index.php'));}

$id = $_GET['id'];
$member = Member::find_by_id($id);

// redirects
if($member == false) {redirect_to(url_for('/member/profiles/index.php'));}
if(get_session_id()!=$id){redirect_to(url_for('/index.php'));}
